...
public class NG2DLevelDesigner extends NGLevelDesigner {
    ...
    protected void CreateStage(){
        ...
        try {
            ...
            FStage.setScene(new Scene(lRoot, 880, 880, Color.WHITE));
                ...
                if (prop.getName().startsWith("GAMEFIELD.")) {
                    ...
                    if (layer != null) {
                        ...
                        if (op.equals("COUNT")) {
                            ...
                            NG2DObjectPosition pos = null;
                            for (NGGameEngineMemoryCell cell : layer.getCells()) {
                                if (cell.getValueAsInteger() == prop.getValue()) {
                                    pos = new NG2DObjectPosition(cell.getAddress().getOffset(), cell.getAddress().getBase());
                                }
                            }
                            if (pos != null) {
